  ...
  <div class="home">
    ...
    <tbody>
        <tr>
            <td>
              <div>
               <p class="text" id="switch">Switch without users</p> 
        ...
        <tr>
            ...
            <td @mouseover="hover1 = true"
            @mouseleave="hover1 = false">
              <div v-if="hover1">
                <button class="btn btn-light border-dark">+</button>
                <button class="btn btn-light border-dark">-</button>
              </div>
            </td>
            <td @mouseover="hover2 = true"
   ...
   <button type="button" class="btn btn-light border-primary rounded-pill text-primary dropdown-toggle" id="addUserBtn" data-bs-toggle="dropdown" aria-expanded="false">
              Add more Users
            </button>
    </div>
      </div>
...
import JobSchedularHeader from '../components/JobSchedularHeader.vue';
